<template>
	<view>
		...
		<view class="fixed">
			<cu-custom bgColor="bgcolor text-white"><block slot="content">XXX小程序</block></cu-custom>
		</view>
		<view class="page">
			...
			<view class="flex justify-between flex-wrap">
				...
				<view class="menuItem" @tap="$navto.navto('/pages/index/pdList',{id:7,title:'机电实验室'})">
					<view class="itemIcon">
						<!-- <u-icon name="photo" class="" size="50"></u-icon>
						 -->
				...
				<view class="menuItem" @tap="$navto.navto('/pages/index/pdList',{id:8,title:'管道实验室'})">
					<view class="itemIcon">
						<!-- <u-icon name="photo" class="" size="50"></u-icon>
						 -->
