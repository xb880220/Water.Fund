<template>
	<view>
		...
		<view class="fixed">
			<cu-custom bgColor="bgcolor text-white">
				<block slot="content">XXX小程序</block>
			</cu-custom>
		</view>
		<view class="page">
			<u-search shape="round" disabled :showAction="false" @click="$navto.navto('/pages/index/searchPage')">
			</u-search>
			<view class="margin-top" :key="lkey">
				<u-swiper :list="list" keyName="content" height="200" class="" indicator indicatorMode="line" circular>
				</u-swiper>
			</view>
			<view class="margin-top-sm">
				<u-notice-bar :text="text" bgColor="#eaeaea" color="#9A9A9A"></u-notice-bar>
			</view>
			<view class="flex justify-between flex-wrap">
				...
				<view class="menuItem" @tap="$navto.navto('/pages/index/pdList',{id:7,title:'机电实训室'})">
					<view class="itemIcon">
						<!-- <u-icon name="photo" class="" size="50"></u-icon>
						 -->
						<view><img style="width: 40px;height: 40px;" src="../../../static/home/02.png" alt="" /></view>
					</view>
				...
				<view class="menuItem" @tap="showCenter(2)">
					<view class="itemIcon">
						<!-- <u-icon name="photo" class="" size="50"></u-icon>
						 -->
				...
				<view class="menuItem" @tap="$navto.navto('/pages/map/index')">
					<view class="itemIcon">
						<!-- <u-icon name="photo" class="" size="50"></u-icon>
						 -->
			...
			<view class="cu-card newCard">
				<view class="header flex justify-between">
					...
					<view class="moreBtn" @tap="$navto.navto('/pages/news/index')">更多</view>
				</view>
				<view class="newsContent">
					<view v-for="(item, index) in news" :key="index" class="newsItem"
						@tap="$navto.navto('/pages/news/details', { id: item.id })">
						<img :src="item.photoUrl" alt="" style="" />
						<view style="" class="title">{{ item.title }}</view>
					</view>
					<view class="" style="margin: 0 auto;" v-if="elements.length == 0">
						<u-empty mode="data" :icon="icon"></u-empty>
					</view>
				</view>
			</view>
		</view>
